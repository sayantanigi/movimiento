                    ...
                    $i++;
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="<?=admin_url('contacts/delete/'.$contact->id)?>" class="text-danger delete"><span class="fa fa-trash"></span></a>
                        </td>
                      </tr>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="row">
                                  ...
                                  <form action="<?=admin_url('contacts/contacts_reply/'.$contact->id)?>" method="post">
