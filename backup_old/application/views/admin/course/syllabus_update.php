    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <form action="<?= admin_url('course/update_save_syllabus/' . $this->uri->segment(4) . '/' . $this->uri->segment(5)) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-sm-10">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="frm[syllabus_content]" id="editor1"><?= @$course->syllabus_content ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
