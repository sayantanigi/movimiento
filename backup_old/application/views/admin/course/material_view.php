                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (!empty(@$course_v->material_description)) {
                                    ...
                                    <a href="<?= admin_url('course/update_material/' . $this->uri->segment(4) . '/' . $course_v->id) ?>" class="btn btn-xs btn-info"><span class="fa fa-eye"></span> View</a>
                                <?php } else {
                                    echo "&#8212;";
                                } ?>
                                </div>
