                                                        ...
                                                        foreach ($ecms as $i) {
                                                            ...
                                                            <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive"
                                                                ...
                                                                <td style="max-width:200px;">
                                                                    <?php echo $i->mode_title; ?>
                                                                </td>
                                                                <td style="max-width:250px;">
                                                                    <div class="form-group">
                                                                        <div class="col-md-5">
                                                                            <select name="mode_status" id="stachange"
                                                                                onchange="f1(this.value,<?php echo $i->id; ?>)"
                                                                                style="padding:4px;">
                                                                                <option value="1" <?php if ($i->mode_status == 1) { ?>
                                                                                        selected="selected" <?php } ?>>Active
                                                                                </option>
                                                                                <option value="0" <?php if ($i->mode_status == 0) { ?>
                                                                ...
                                                                <td style="max-width:50px;"><a
                                                                        ...
                                                                        href="<?php echo base_url() ?>supercontrol/mode/show_mode_id/<?php echo $i->id; ?>">Edit</a>
                                                                </td>
