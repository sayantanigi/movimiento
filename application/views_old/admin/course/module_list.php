              ...
              <tbody class="row_position">
                ...
                ?>
                    <tr id="<?php echo @$course_v->id ?>" class="draggable">
                      ...
                      <td>
                        <div class="truncate_name1"><?= $course_v->name ?></div> <input type="hidden" name="pref[]" value="<?= $course_v->id ?>">
                      </td>
                      <td>
                        <div class="truncate_desc1"><?= strip_tags($course_v->module_descriptions) ?></div>
                      </td>
                      <td>
