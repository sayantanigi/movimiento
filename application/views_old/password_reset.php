...
<section class="page__title-area page__title-height page__title-overlay d-flex align-items-center" data-background="<?= base_url()?>assets/img/page-title/page-title-2.jpg"  style="min-height: <?php if($this->uri->segment(1) == 'reset_password') {echo "200px !important"; } else { echo ""; }?>">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3 col-lg-8 offset-lg-2">
                <div class="sign__wrapper white-bg">
                    <div class="sign__form">
                        ...
                        <?php } ?>
                        <form name="form1" id="resetFormValidation" autocomplete="off" method="post" action="<?= base_url('home/changePassword') ?>">
                        <div class="sign__input-wrapper mb-25">
                                <h5>Old Password</h5>
                                <div class="sign__input">
                                    <input type="password" placeholder="Old Password" name="old_password" id="old_password" required="">
                                    <div class="eyepanel"><i class="fa fa-eye-slash" id="eyer"></i></div>
