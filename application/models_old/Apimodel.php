...
class Apimodel extends CI_Model
{
 ...
 public function filter_data_exist($mobile, $primary_key, $primary_key_name, $column_name, $table_name)
 {
 ...
 public function username_exists($username)
  ...
  public function userclassname_exists($user_class_name)
  {
    $where = array( 
   ...
   $this->db->where($where);
   $query = $this->db->get('user_classes');
 ...
 public function categories_exists($category_name)
  {
    $where = array( 
 ...
 public function usertypes_exists($user_types, $user_id, $condo_id)
 {

    $getSql = "SELECT * FROM `user_types` WHERE `user_type_name` = '".$user_types."' AND `user_id` = '".$user_id."' AND `condo_id` = '".$condo_id."'";

    $count = $this->db->query($getSql)->num_rows();
 ...
 public function unitclassname_exists($unit_class_name)
  {
    $where = array( 
   ...
   $this->db->where($where);
   $query = $this->db->get('unit_classes');
