...
class Category_model extends CI_Model {
    ...
    public function category_menu() {
        $query = $this->db->query("select category_id, category_name, parent_id from sm_category order by category_id");
        $cat = array(
            'items' => array(),
            'parents' => array()
        );
    ...
    public function category_menu_category() {
        $query = $this->db->query("select category_id, category_name, parent_id from " . $this->sm_category . " order by category_id");
        $cat = array(
            'items' => array(),
            'parents' => array()
        );
    ...
    function category_edit($id, $datalist) {
        $this->db->where('id', $id);
        $this->db->update('cr_category', $datalist);
    }
