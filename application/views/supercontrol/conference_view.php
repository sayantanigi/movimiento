                                            ...
                                            <div id="mydiv">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="table table-striped table-bordered table-hover table-checkable order-column dt-responsive" id="sample_1">
                                                        ...
                                                        <td style="max-width:150px;"> <?php echo date('Y-m-d', strtotime($i->date)); ?> </td>
                                                        <td style="max-width:200px;"> 
                                                        <?php if(empty($i->attachment)) { ?> 
                                                            Null;
                                                        <?php } else { ?>
                                                            <a href="<?php echo base_url()."uploads/conference/".$i->attachment?>" target="_blank">File Attachment</a>
                                                        <?php } ?>
                                                        </td>
                                                        ...
                                                        <td style="max-width:80px;"><a
                                                                ...
                                                                href="<?php echo base_url() ?>supercontrol/conference/show_conference_id/<?php echo $i->id; ?>">Edit</a>
                                                        </td>
                                                        <td style="max-width:80px;">
                                                            <a class="btn red btn-sm btn-outline sbold uppercase" onclick="return confirm('Are you sure about this delete?');" href="<?php echo base_url() ?>supercontrol/conference/delete_conference/<?php echo $i->id; ?>">Delete</a>
                                                        </td>
                                                    </tr>
                                                    <?php $ctn++; } } ?>
                                                </tbody>
    ...
    $(document).ready(function () {
        ...
        $("#del_all").on('click', function (e) {
            ...
            $.ajax({
                ...
                url: '<?php echo base_url() ?>supercontrol/conference/delete_multiple',
                type: 'post',
                data: 'ids=' + checkValues
            }).done(function (data) {
                $("#respose").html(data);
                //location.reload();
                var newurl = '<?php echo base_url() ?>supercontrol/conference/show_conference';
...
<script>
    function f1(stat, id) {
        $.ajax({
            type: "get",
            url: "<?php echo base_url(); ?>supercontrol/conference/statusconference",
