                            ...
                            <div class="tab-pane active" id="tab_0">
                                <div class="portlet box blue-hoki">
                                    ...
                                    <div class="portlet-body form">
                                        <!-- BEGIN FORM-->
                                        <form action="<?php echo base_url() . 'supercontrol/blog/add_blog' ?>"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="form-group last">
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <div class="clearfix margin-top-10"> <span
                                                                class="label label-danger">Format</span> jpg, jpeg, png,
                                                            gif </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <?php echo form_input(array('id' => 'blog_title', 'name' => 'blog_title', 'class' => 'form-control')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <?php echo form_input(array('id' => 'posted_by', 'name' => 'posted_by', 'class' => 'form-control')); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <?php echo form_textarea(array('id' => 'pagedes', 'name' => 'blog_desc', 'class' => 'form-control')); ?>
