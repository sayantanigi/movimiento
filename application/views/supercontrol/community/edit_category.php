                            ...
                            <div class="tab-pane active" id="tab_0">
                                <div class="portlet box blue-hoki">
                                    <div class="portlet-title">
                                        <div class="caption"> <i class="fa fa-gift"></i>Edit Community Category</div>
                                        <div class="tools">
                                    ...
                                    <div class="portlet-body form">
                                        <form action="<?php echo base_url().'supercontrol/community/edit_community_cat/'.$eallcat->id?>" class="form-horizontal form-bordered" method="post" enctype="multipart/form-data" onsubmit="return check();">
                                            <div class="form-body">
                                                <div class="form-group">
                                                    <b><label class="col-md-3 control-label">Category Title *</label></b>
                                                    <div class="col-md-4">
                                                        <input type="text" name="category_name" id="title" class="form-control" placeholder="Name" onkeyup="leftTrim(this)" value="<?= $eallcat->category_name ?>" required/>
