        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div id="page-wrapper">
                        <div class="container-fluid">
                            <form action="<?= base_url('admin/cms/savePrivacy')?>" method="POST" enctype="multipart/form-data" id="submitAboutus">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-body">
...
$(document).ready(function () {
    $("#submitAboutus").on('submit', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('admin/cms/savePrivacy'); ?>',
            ...
            success: function (data) {
                ...
                if (data.status == 1) {
                    swal({title: "Sucess!", text: "<strong>" + data.message + "</strong>", type: "success", showConfirmButton: true, html: true}, function () {
                        window.location.href = "<?= base_url('admin/cms/privacy') ?>"
                    });
                }
            }
        });
