        ...
        <div class="container-fluid">
            <section class="bg-light-gray">
                <div class="container">
                    ...
                    <form id="submitform" action="<?= base_url('admin/course/edit_course/'.@$result->id)?>" method="post" enctype="multipart/form-data" >
                        <div class="row">
                                ...
                                <div class="card shadow rounded">
                                    <div class="card-body">
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" class="form-control" name="course_name" id="course_name" required autocomplete="off" value="<?= @$result->course_name ?>">
                                        </div>
                                        <small id="course_error"></small>
                                        <div class="form-group mb-2">
                                            <label class="fw-semibold text-black">Short Description</label>
                                            <textarea class="form-control" name="course_short_description" id="course_short_description" required autocomplete="off"><?= @$result->course_short_description ?></textarea>
                                        </div>
                                        <small id="shortdesc_error"></small>
                                        <div class="form-group mb-2">
                                            <label class="fw-semibold  text-black">Course Description</label>
                                            <textarea class="form-control" name="course_description" id="course_description" required autocomplete="off"><?= @$result->course_description ?></textarea>
                                        </div>
                                        <small id="coursedesc_error"></small>
                                        <div class="form-group mb-2">
                                            <label class="fw-semibold  text-black">Address</label>
                                            <input type="text" class="form-control" name="address" id="autocomplete" value="<?= @$result->address ?>">
                                        ...
                                        <div class="form-group mb-2">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <!-- <input type="text" class="form-control" name="pincode" id="pincode" value="<?= @$result->pincode ?>"> -->
                                                    <select class="form-control" name="pincode" required id="pincode">
                                                        <option value="">Select Zipcode</option>
                                                        <?php if(!empty($zipcodeList)) {
                                                        foreach($zipcodeList as $zipcode) { ?>
                                                        <option value="<?= $zipcode->zipcode; ?>" <?php if(@$result->pincode == $zipcode->zipcode) {echo "selected"; }?>><?= $zipcode->zipcode; ?></option>
                                                        <?php } } else { ?>
                                        ...
                                        <div class="form-group mb-2">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="course_duration" id="course_duration" required autocomplete="off" value="<?= @$result->course_duration ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="fw-semibold  text-black">Course Classes</label>
                                                    <input type="text" class="form-control" name="course_class" id="course_class" required autocomplete="off" value="<?= @$result->course_class ?>">
                                                </div>
                                                <!-- <div class="col-sm-4">
                                                    <label class="fw-semibold  text-black">Class Duration</label>
                                                    <input type="text" class="form-control" name="class_duration" id="class_duration" required autocomplete="off" value="" readonly>
                                                </div> -->
                                                <div class="col-sm-6">
                                                    <label class="fw-semibold  text-black">Actual Price</label>
                                                    <input type="text" class="form-control" name="course_price" id="course_price" required autocomplete="off" value="<?= @$result->course_price ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="fw-semibold  text-black">Offer Price</label>
                                                    <input type="text" class="form-control" name="offer_price" id="offer_price" required autocomplete="off" value="<?= @$result->offer_price ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="hidden" class="form-control" name="old_image" value="<?= @$result->course_image?>" >
                                        </div>
                                        <div class="form-group mb-2">
                                            <label class="fw-semibold  text-black">Course Type</label>
                                            <select class="form-control" name="course_type" required id="userstatus">
                                                <option value="">Select Course Type</option>
                                                <option value="1" <?php if(@$result->course_type == "1"){echo "selected";}?>>Course for Adult</option>
                                                <option value="2" <?php if(@$result->course_type == "2"){echo "selected";}?>>Course for Teenager</option>
                                            </select>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="profile clearfix">
                                                        <div class="image item" id="Cover-Image">
                                                            <img src="<?= !empty(@$result->course_image) ? base_url('uploads/course/' . @$result->course_image . '') : base_url('uploads/bnr.jpg'); ?>" class="img-cover" id="blah">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="mt-3" style="margin-top: 5px !important;">
                                                            <div class="tx-11 font-weight-bold mb-0 ">
                                                                <b>Course Name: </b><p class="text-muted" id="coursename" style="display: contents"><?= @$result->course_name ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="mt-3" style="margin-top: 5px !important;">
                                                            <div class="tx-11 font-weight-bold mb-0 ">
                                                                <b>Course Duration: </b><p class="text-muted" id="courseweek" style="display: contents"><?= @$result->course_week ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="mt-3" style="margin-top: 5px !important;">
                                                            <div class="tx-11 font-weight-bold mb-0 ">
                                                                <b>Classes per Week: </b><p class="text-muted" id="classweek" style="display: contents"><?= @$result->class_week ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="mt-3" style="margin-top: 5px !important;">
                                                            <div class="tx-11 font-weight-bold mb-0 ">
                                                                <b>Actual Price: </b><p class="text-muted" id="courseprice" style="display: contents"><?= @$result->course_price ?></p>
                                                            </div>
                                                        </div>
                                                        <div class="mt-3" style="margin-top: 5px !important;">
                                                            <div class="tx-11 font-weight-bold mb-0 ">
