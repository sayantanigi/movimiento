...
<head>
    <meta charset="utf-8" />
    <title><?= (!empty($page) && $page != '') ? $page . ' | ' : ''; ?><?= @$setting->title ?></title>
                ...
                <div class="d-flex">
                    <div class="navbar-brand-box">
                        <a href="<?= base_url('admin/dashboard') ?>" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="<?= base_url('uploads/logos/' . @$setting->logo) ?>" alt="<?= @$setting->title; ?>" height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="<?= base_url('uploads/logos/' . @$setting->logo) ?>" alt="<?= @$setting->title; ?>" height="20">
                            </span>
                        </a>
        ...
        <div class="vertical-menu">
            <div class="navbar-brand-box" style="background: #fff;">
                <a href="<?= base_url('admin/dashboard') ?>" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="<?= base_url('uploads/logos/'.@$setting->sec_logo) ?>" alt="<?= @$setting->title; ?>" height="22">
                    </span>
                </a>
                <a href="<?= base_url('admin/dashboard') ?>" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?= base_url('uploads/admin/handlogo.png') ?>" alt="<?= @$setting->title; ?>" height="22" style="margin-left: -20px;">
                    </span>
                    <span class="logo-lg">
                        <img src="<?= base_url('uploads/logos/' . @$setting->logo) ?>" alt="<?= @$setting->title; ?>" height="22">
                    </span>
