                  ...
                  if(is_array($contacts) && count($contacts)>0){
                    ...
                    foreach ($contacts as $contact) {
                      ...
                      <tr>
                        ...
                        <td>
                         <a href="<?=admin_url('contacts/stay_delete/'.$contact->id)?>" class="text-danger delete"><span class="fa fa-trash"></span></a>
                        </td>
                      </tr>
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="row">
                                  ...
                                  <form action="<?=admin_url('contacts/stayin_touch_reply/'.$contact->id)?>" method="post">
