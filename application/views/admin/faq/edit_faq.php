                                ...
                                <div class="card-body">    
                                    <form id="submitform" method="post" enctype="multipart/form-data" >
                                        <div class="form-group mb-2">
                                            ...
                                            <input type="text" class="form-control" name="question"  id="question"  autocomplete="off" value="<?php echo!empty($faq->question) ? $faq->question : ''; ?>">
                                        </div>
...
<script>
    $(document).ready(function () {
        $("#submitform").on('submit', function (e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url('admin/faq/editfaq'); ?>',
