...
<section class="content">
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <!-- <h3 class="box-title">Community Comment Lists</h3> -->
                    <div class="col-lg-12">
                        <div class="communityList  d-flex  p-3 mb-3" style="border: 1px solid #eee; padding: 20px; border-radius: 20px !important;">
                            <div class="userComInfo" style="width: 100%;">
                        ...
                        <?php
                        $getData = $this->db->query("SELECT * FROM admin WHERE id = '".$this->session->userdata('userid')."'")->row();
                        ?>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 col-sm-6 col-lg-6">
                                        <div class="blog__comment-input">
                                            <input type="text" placeholder="Your Name" name="full_name" id="full_name" value="<?= $getData->username ?>" readonly required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-sm-6 col-lg-6">
                                        <div class="blog__comment-input">
                                            <input type="email" placeholder="Your Email" name="email" id="email" value="<?= $getData->email_id ?>" readonly required>
                                        </div>
                                    </div>
                                    <div class="col-sm-6 col-sm-6 col-lg-6">
                                        <div class="blog__comment-input">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="blog__comment-btn">
                                            <button type="button" class="e-btn btn btn-primary" onclick="postComment()" id="postButton">Post Comment</button>
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content" id="comment_data">
            ...
            </div>
        </div>
    </div>
...
.select2-container--default{width: 100% !important;border-radius: 15px;}
...
function getCatwisecommentData(id){
    ...
    var comm_id = $('#comm_id').val();
    $.ajax({
        url: "<?= admin_url('community/getCatwisecommentData') ?>",
        type: "POST",
