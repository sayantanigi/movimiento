            ...
            <div class="row align-items-end">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-8">
                    <div class="section__title-wrapper mb-45">
                        <h2 class="section__title">Explore Our Popular Courses</h2>
                    </div>
                </div>
                ...
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <div class="category__item mb-30 transition-3 d-flex align-items-center">
                        ...
                        <div class="category__content">
                            <h4 class="category__title"><a href="#">Data Science</a></h4>
            ...
            <div class="row align-items-end">
                <div class="col-xxl-12 col-xl-12 col-lg-12">
                    <div class="section__title-wrapper mb-60">
                        <h2 class="section__title">Find the Right Online Course for you</h2>
                    </div>
                </div>
            </div>
            <div class="row grid">
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 grid-item cat1 cat2 cat4">
                    <div class="course__item white-bg mb-30 fix">
                        ...
                        <div class="course__content">
                            ...
                            <h3 class="course__title"><a href="#">Become a product Manager learn the skills & job.</a>
                            </h3>
